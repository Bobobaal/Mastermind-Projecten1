...
import domein.rij.RijMoeilijk;

/**
 * Klasse dat een moeilijk spel voorstelt.
 *
 * @author groep 31
 */
public class SpelMoeilijk extends Spel {

    /**
     * Maak een nieuw, 'moeilijk' spel aan.
     *
     */
    public SpelMoeilijk() {
        super(3, 12, 5, true, false);
    }
    ...
    public String toString() {
        ...
        string += TAAL.getString("moeilijkheidsgraad") + ": " + TAAL.getString("moeilijk");
